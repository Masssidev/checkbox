...
<body>
	<div class="container">
		...
		<form:form method="post" modelAttribute="inputFormModel">
			<div class="form-group">
				...
				<div class="radio-list">
					<form:radiobuttons path="color1" items="${ options }"
			...
			<div class="form-group">
				...
				<div class="checkbox-list">
					<form:checkboxes path="color2" items="${ options }"
						itemValue="value" itemLabel="label" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="checkbox-list">
					<form:select path="color3" class="form-control"
						style="width:200px;" items="${ options }" itemValue="value"
						itemLabel="label" />
				</div>
			</div>
			<div class="form-group">
		...
		<table class="table table-bordered" style="width: 500px;">
			...
			<tr>
				<td>석택2</td>
				<td><c:forEach var="c" items="${ inputFormModel.color2 }">             ${ c }           </c:forEach>
				</td>
			</tr>
			<tr>
				<td>선택3</td>
